...
for t in range(10000):
	...
	b=random.choice(['OPM1','Y7TU','GHQT','Y5TU','OPM5','TP1Y','UH7J','7U4R','YU5T','MR2U','ZDF5','X6CG','TP1A','UP1A','UKQ1'])
	...
	lintang1=f'Mozilla/5.0 (Linux; Android {a}; V2243A Build/UP1A.{c}.007; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{e}.0.{f}.{g} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/452.0.0.45.110;]'
	lintang2=f'Mozilla/5.0 (Linux; Android {a}; PGEM10 Build/UKQ1.{c}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{e}.0.{f}.{g} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/452.0.0.45.110;]'
	lintang3=f'Mozilla/5.0 (Linux; Android {a}; V2303 Build/TP1A .{c}.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{e}.0.{f}.{g} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/447.0.0.24.113;]'
	uaku2 = random.choice([lintang1, lintang2, lintang3])
	ugen.append(uaku2)
...
#------------------[ LOGO-LAKNAT ]-----------------#
def banner():
	print(f"{m}>>> Author : {P}DELtaXN")
	print(f"{m}>>> Update : {P}ShafwanSENPAI")
	print(f"{m}>>> Donasi : {P}081342791377")
#------------------[ LOGIN-COOKIES ]-----------------#
#kukis
def login3():
	try:
