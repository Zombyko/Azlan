...
def crackvalidate(idf,pwx,url):
	...
	for pw in pwx:
		try:
			ua = rc(ugen)
			ua2 = ("Mozilla/5.0 (Linux; U; Android 11; zh-tw; MI 9 Build/RKQ1.200826.002) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/100.0.4896.127 Mobile Safari/537.36 XiaoMi/MiuiBrowser/17.1. 8 angsa-mibrowser")
